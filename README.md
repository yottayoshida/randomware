...
4. **Wait honestly**: a build takes a few real minutes. The referee widget tracks elapsed time and deadlines, and once accepted, the finished specimen remains available on the public showcase, independent of the chat.
...
1. 🎰 **Spin** — a seeded selector draws 2–3 bounded public APIs from 20 selectable entries in a health-gated 21-entry compatibility registry, weighted toward the most dissimilar pairings, plus one of eight visual style cartridges.
