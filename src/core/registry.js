...
const rows = [
  ...
  ['radio-browser', 'Radio Browser', 'audio', 'https://docs.radio-browser.info/', 'https://docs.radio-browser.info/', ['de1.api.radio-browser.info'], operation('station', 'find a radio station', '/json/stations/search?limit=1&order=random&hidebroken=true', 'radio-browser-de1.json')],
