...
function createMcpTools(app) {
  return [
    ...
    { name: 'submit_concept', description: 'Use this after spin_apis to submit the concept contract.', inputSchema: { type: 'object', properties: { runId: { type: 'string' }, requestId: { type: 'string' }, appName: { type: 'string' }, premise: { type: 'string' }, apiIds: { type: 'array' } }, required: ['runId','requestId','appName','premise','apiIds'] }, annotations: { readOnlyHint: false, openWorldHint: true, destructiveHint: false } },
